...
namespace SBTest
{
    public class App : Application
    {
        ...
        public App()
        {
            ...
            sendTextButton.Clicked += sendTextHandler;
            ...
            view.Children.Add(sendTextButton);
        ...
        public void sendTextHandler(object sender, EventArgs eventE){
            string currentText = textBox.Text;
            System.Diagnostics.Debug.WriteLine("Current text in text box is: {0}", currentText);
            //channel.SendUserMessage(currentText, (UserMessage message, SendBirdException e) => {
            //    if (e != null)
            //    {
            //        // An error has occurred while sending a message.
            //        System.Diagnostics.Debug.WriteLine("An error has occurred " +
            //                                           "in sendTextHandler while sending a message");
            //        System.Diagnostics.Debug.WriteLine("error: " + e.Code);
                    
            //    }else{
            //        System.Diagnostics.Debug.WriteLine("Successfull sent message: {0}",currentText);
            //    } 

            //});
            try
            {
                channel.SendUserMessage(currentText, (message, e) =>
                {
                    if (e != null)
                    {
                        System.Diagnostics.Debug.WriteLine("currentText: {0}",currentText);

                        System.Diagnostics.Debug.WriteLine("error when sending message");
                        return;
                    }
                });
            }
            catch (Exception ex)
            {
                ...
                System.Diagnostics.Debug.WriteLine(eventE);
